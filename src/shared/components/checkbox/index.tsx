    ...
    return (
      <>
        <div class='w-full  flex flex-col items-center justify-start'>
          <div class='w-full flex items-center justify-start gap-2 peer focus:outline-2 focus:outline-emerald-400 focus:outline'>
            <input
              id={name}
              name={name}
              title={name}
              type='checkbox'
              class={[
                'peer relative appearance-none w-5 h-5 border-2 border-emerald-600 rounded-md transition-transform duration-200 rotate-0 scale-100',
                // 'focus:outline-none',
